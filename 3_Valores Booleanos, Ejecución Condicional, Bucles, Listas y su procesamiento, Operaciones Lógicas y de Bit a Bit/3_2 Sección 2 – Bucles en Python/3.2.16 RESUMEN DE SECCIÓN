...
# ejemplo de el uso de break para salir de un bucle
...
# ejemplo de continue para omitir la iteración actual y continuar con la siguiente iteración
text = "OpxenxxEDxG Pxythxxxoxn Ixxnstxituxxxxte"
for letter in text: 
    if letter == "x":
        continue
    print(letter, end="")
