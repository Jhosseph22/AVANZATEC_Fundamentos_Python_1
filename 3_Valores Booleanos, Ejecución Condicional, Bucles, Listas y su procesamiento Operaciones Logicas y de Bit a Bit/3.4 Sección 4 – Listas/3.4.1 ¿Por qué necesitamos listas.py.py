# # # # Puede suceder que tengas que leer, almacenar, 
# # # # procesar y, finalmente, imprimir docenas, 
# # # # quizás cientos, tal vez incluso miles de números. 
# # # # ¿Entonces qué? ¿Necesitas crear una variable separada 
# # # # para cada valor? ¿Tendrás que pasar largas horas escribiendo
...
print(numbers[2])  # Imprime el tercer elemento de la lista
print(numbers[3])  # Imprime el cuarto elemento de la lista
print(numbers[4])  # Imprime el quinto elemento de la lista
